          ...
          <AnimationContainer className="flex flex-col items-center justify-center w-full text-center">
            <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
              ...
              <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1">
                ✨ Experience Science Experiments for Free
            ...
            <p className="mb-12 text-lg tracking-tight text-muted-foreground md:text-xl text-balance">
              Learn and practice real science experiments online, anytime,
              <br className="hidden md:block" />
              <span className="hidden md:block">
                anywhere, completely free with our virtual labs.
              </span>
            </p>
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              <h2 className="bg-gradient-to-b from-neutral-200 to-neutral-400 py-4 bg-clip-text text-center text-4xl md:text-7xl !leading-[1.15] font-medium font-heading tracking-tight text-transparent mt-8">
                Discover and Practice Science Experiments for Free
              </h2>
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Practice real science experiments online with interactive
                virtual labs. Learn anytime, anywhere, completely free, and make
